package net.chefcraft.reflection.version.v1_21_R3.particles;
...
public class ChefParticleBase implements CoreParticle {
	...
	public static final CoreRegistry<CoreParticle> REGISTRY = new CoreRegistry<>(
			ChefParticleBase.create(Particle.POOF, "poof"),
		 	...
		 	//1.21.5
		 	ChefParticleBase.create(Particle.CHERRY_LEAVES, "tinted_leaves", CoreParticleDataType.COLOR), 
		 	ChefParticleBase.create(Particle.WHITE_ASH, "firefly"), 
	
		 	//1.21.9
		 	ChefParticleBase.create(Particle.FLAME, "copper_fire_flame")
	);
