...
interface ChefPacketBuilder {
    ...
    class Scoreboard implements PacketBuilder.Scoreboard {
        ...
        public Packet<?> resetScore(String objectiveName, String entry) {
            ...
            ObjectHelper.setField(packet, "b", objectiveName);
            return packet;
        }
        ...
        public Packet<?> setObjective(ObjectiveMethod method, String objectiveName, MessageHolder displayName, CoreScoreRenderType renderType, @Nullable CoreNumberFormat numberFormat) {
            ...
            ObjectHelper.setField(packet, "a", objectiveName);
    ...
    class ScoreboardTeam implements PacketBuilder.Scoreboard.SetPlayerTeam {
        ...
        public int setPackOptionData(boolean friendlyFire, boolean canSeeFriendlyInvisibles) {
            int i = 0;
            if (friendlyFire) i |= 1;
            if (canSeeFriendlyInvisibles) i |= 2;
            return i;
        }
        ...
        public Packet<?> build(String name, Action action, Collection<String> players, CoreTeamData team) {
            ...
            ObjectHelper.setField(packet, "a", name);
            ...
            if (action == Action.CREATE || action == Action.UPDATE) {
                ...
                ObjectHelper.setField(packet, "c", team.getPrefix().asString(true));
                ObjectHelper.setField(packet, "d", team.getSuffix().asString(true));
                ...
                ObjectHelper.setField(packet, "i", setPackOptionData(team.isAllowFriendlyFire(), team.canSeeFriendlyInvisibles()));
            }
            return packet;
        }
    }
